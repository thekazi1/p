...
def main():
    ...
    bestRoute = geneticAlgorithm(cityList, popSize=100, eliteSize=20, mutationRate=0.01, generations=500)
    print("Best Route:", bestRoute)

    geneticAlgorithmPlot(cityList, popSize=100, eliteSize=20, mutationRate=0.01, generations=500)
